...
/***/ function(module, exports, __webpack_require__) {
	...
	(function() {
	    ...
	    this.createWorker = function(session) {
	        var worker = new WorkerClient(["ace"], __webpack_require__(3), "JavaScriptWorker");
	...
	(function() {
	    ...
	    this.createWorker = function(session) {
	        var worker = new WorkerClient(["ace"], __webpack_require__(4), "Worker");
	        worker.attachToDocument(session.getDocument());
	...
	(function() {
	    ...
	    this.createWorker = function(session) {
	        if (this.constructor != Mode)
	            return;
	        var worker = new WorkerClient(["ace"], __webpack_require__(5), "Worker");
	        worker.attachToDocument(session.getDocument());
